...
author: "Steven Yu, Renee Matthews edits"
date: "2025-08-01"
...
# write_delim(all_peak_final,"data/all_peak_final_dataframe.txt",delim = "\t")
```
...
```{r H3K27ac volcano 3, fig.width=8}
...
```{r H3K27me3 volcano 3, fig.width=8}
V.24T.top= topTable(efit2, coef=1, adjust.method="BH", number=Inf, sort.by="p")
V.24R.top= topTable(efit2, coef=2, adjust.method="BH", number=Inf, sort.by="p")
V.144R.top= topTable(efit2, coef=3, adjust.method="BH", number=Inf, sort.by="p")
...
```{r H3K36me3 volcano 3, fig.width=8}
V.24T.top= topTable(efit2, coef=1, adjust.method="BH", number=Inf, sort.by="p")
V.24R.top= topTable(efit2, coef=2, adjust.method="BH", number=Inf, sort.by="p")
V.144R.top= topTable(efit2, coef=3, adjust.method="BH", number=Inf, sort.by="p")
...
```{r H3K9me3 volcano 3, fig.width=8}
V.24T.top= topTable(efit2, coef=1, adjust.method="BH", number=Inf, sort.by="p")
V.24R.top= topTable(efit2, coef=2, adjust.method="BH", number=Inf, sort.by="p")
V.144R.top= topTable(efit2, coef=3, adjust.method="BH", number=Inf, sort.by="p")
...
pca_plot(pca_H3K27ac, col_var = "time", shape_var = "tx", text_var = pca_H3K27ac$ind, title = "H3K27ac filtered lcpm PCA")
```
...
pca_plot(pca_H3K27me3, col_var = "time", shape_var = "tx", text_var = pca_H3K27me3$ind, title = "H3K27me3 filtered lcpm PCA")
```
```{r H3K27me3 HeatMap 2, fig.width=14,fig.height=14}
