...
test will be number of regions in set2 assigned to protein data gene, number of regions in set 2 not assigned to protein data gene, compared to number of regions assigned to set1 vs not assigned to protein data gene in set 1.
  ...
  more specifically I want to test if Set 2 regions are more frequently assigned to differential abundant proteins than set 1 H3K27ac regions.
...
great_matrix <- matrix(c(5,56,17,161), nrow = 2)
...
repID_to_gene_MER61E %>% 
  ...
  group_by(my_MER,DOX_cor) %>% 
  tally
great_matrix_set3 <- matrix(c(3,34,19,183), nrow = 2)
