...
my_matrix <- matrix(c(3,64,10,190), nrow = 2)
...
tf_uni_matrix_set2 <- matrix(c(11,19,262,487), nrow = 2)
...
tf_uni_matrix_set3 <- matrix(c(6,24,30,719), nrow = 2)
...
tf_uni_matrix_set2_k9 <- matrix(c(1,29,44,705), nrow = 2)
...
tf_uni_matrix_set3_k9 <- matrix(c(0,30,12,737), nrow = 2)
...
tf_uni_matrix_setshare <- matrix(c(4,26,169,580), nrow = 2)
