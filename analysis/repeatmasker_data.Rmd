...
datatable(H3K27ac_results_1bp,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K27ac_results_50per,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K27me3_results_1bp,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K27me3_results_50per,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K36me3_results_1bp,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K36me3_results_50per,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K9me3_results_1bp,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
...
datatable(H3K9me3_results_50per,options = list(pageLength = 20, autoWidth = TRUE),
  rownames = FALSE))
