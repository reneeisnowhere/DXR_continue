...
# write_delim((H3K27ac_merged_raw %>% 
#                as.data.frame(.) %>%
#                rownames_to_column("Peakid")),"data/DER_data/H3K27ac_filtered_raw_counts.txt",delim = "\t")
# write_delim((H3K27me3_merged_raw%>% as.data.frame(.)%>%
#                rownames_to_column("Peakid")),"data/DER_data/H3K27me3_filtered_raw_counts.txt",delim = "\t")
# write_delim((H3K36me3_merged_raw%>% as.data.frame(.)%>%
#                rownames_to_column("Peakid")),"data/DER_data/H3K36me3_filtered_raw_counts.txt",delim = "\t")
# write_delim((H3K9me3_merged_raw%>% as.data.frame(.)%>%
#                rownames_to_column("Peakid")),"data/DER_data/H3K9me3_filtered_raw_counts.txt",delim = "\t")
```
