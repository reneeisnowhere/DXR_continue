---
title: "H3K27me3 summit processing"
...
```{r H3K27me3 get highes per group funciton}
...
```{r H3K27me3 reduced sets grouping}
reduced_sets <- list(
...
```{r H3K27me3 across groups mingap}
...
```{r H3K27me3 double reduce function}
...
```{r H3K27me3 calculating of double reduce}
...
```{r H3K27me3 plot mingap averages}
