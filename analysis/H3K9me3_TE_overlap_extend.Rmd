...
```
```{r anddin in ext_summits only}
te_cols <- c("TE_status","SINE_status","LINE_status","DNA_status","LTR_status","SVA_status")
annotated_H3K9me3_ext_summits <- readRDS("data/TE_annotation/H3K9me3_annotated_summit_TE_overlaps.RDS")
```
...
SINE_overlap_df <- tibble(
  ...
  cluster   = mcols(H3K9me3_summit_gr)$cluster[queryHits(sine_hits)],
...
LINE_overlap_df <- tibble(
  ...
  cluster   = mcols(H3K9me3_summit_gr)$cluster[queryHits(LINE_hits)],
