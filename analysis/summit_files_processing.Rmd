...
```
 reapplying new reduction function
...
temp_highest_per_group <- get_highest_per_group_fast(all_H3K27ac_summits_gr)

get_consensus_summits_fast(highest_per_group_gr = temp_highest_per_group,
                           score_col = "score",
                           min_gap_across = 400)
```
...
### Adding in lost summits to the Peakids

```{r fixing lost summits}
...
fallback_summits <- assign_fallback_summits(ROIs_gr=ROIs_missing, summits_gr=all_H3K27ac_summits_gr, max_dist = 500)
